  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="합리적인 소비를 위한 공동구매 서비스 R09M 채소 상품 페이지"
        />
        <meta
        ...
        <meta property="og:url" content="https://r09m.vercel.app/vegetable" />
        <meta
          property="og:description"
          content="공동구매 채소 상품을 확인할 수 있는 페이지입니다. 카테고리, 상품명, 상세내용, 진행상태, 픽업 일자, 참여자 현황을 확인할 수 있습니다."
        />
        <meta
          name="description"
          content="공동구매 채소 상품을 확인할 수 있는 페이지입니다. 카테고리, 상품명, 상세내용, 진행상태, 픽업 일자, 참여자 현황을 확인할 수 있습니다."
